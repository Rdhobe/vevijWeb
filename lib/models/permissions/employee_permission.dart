...
enum EmployeePermission {
  ...
  addRemoveSupervisor(
    ...
    'Can add or remove supervisors for projects',
  ),
  addRemoveContractor(
    'Add/Remove Contractor',
    'Can add or remove contractors for projects',
  ),
  addRemoveDesigner(
    'Add/Remove Designer',
    'Can add or remove designers for projects',
  ),
  ...
  issueRequestManageProject(
    'Issue/Request Management',
    'Can manage issue and request tickets',
  ),
...
class EmployeePermissionChecker {
  ...
  static Future<List<EmployeePermission>> getUserPermissions(
    String userId,
  ) async {
    final employee = await _getEmployee(userId);
